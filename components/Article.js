...
/*
  ...
  */
const articleMaker = (someData) => {
  const article = document.createElement("div");
  const title = document.createElement("h2");
  const date = document.createElement("p");
  const topContent = document.createElement("p");
  const midContent = document.createElement("p");
  ...
  date.appendChild(topContent);
  topContent.appendChild(midContent);
  midContent.appendChild(bottomContent);
  bottomContent.appendChild(button);
